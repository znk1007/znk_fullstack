...
var (
	//ErrInvalidObjectID is returned when try to parse an invlid ObjectID
...
// NewObjectID 以当前时间初始化
func NewObjectID() ObjectID {
	return NewObjectIDWithTime(time.Now())
}

// NewObjectIDWithTime  以指定时间初始化
...
func FromString(id string) (ObjectID, error) {
	i := &ObjectID{}
...
func (id *ObjectID) UnmarshalText(bytes []byte) error {
...
// Scan 扫码值类型，并返回结果
func (id *ObjectID) Scan(value interface{}) (err error) {
 ...
 * 解码
 */
func decode(id *ObjectID, src []byte) {
	_ = src[19]
	_ = id[11]
