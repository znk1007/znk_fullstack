...
class DeviceHelper {
  ...
  Future<AndroidDeviceHelper> get androidInfo async => 
    _cachedAndroidDeviceHelper ??= AndroidDeviceHelper._fromMap(await methodChannel.invokeMapMethod<String, dynamic>('getAndroidDeviceInfo'));
  
  /// This information does not change from call to call. Cache it.
  IOSDeviceHelper _cacheIOSDeviceHelper;

  Future<IOSDeviceHelper> get iOSInfo async => 
    _cacheIOSDeviceHelper ??= IOSDeviceHelper._fromMap(
      await methodChannel.invokeMapMethod<String, dynamic>('getIOSDeviceInfo')
    );
...
class AndroidDeviceHelper {
  ...
  /// Android operating system values derived from `android.os.Build.VERSION`.
  ...
  /// The Android hardware device ID that is unique between the device + user 
  /// and app signing.
  final String androidId;
  /// Deserializes from the message received from [_kChannel].
  static AndroidDeviceHelper _fromMap(Map<String, dynamic> map) {
    return AndroidDeviceHelper._(
      version:
...
class IOSDeviceHelper {
  ...
  static IOSDeviceHelper _fromMap(Map<String, dynamic> map) {
    return IOSDeviceHelper._(
      name: map['name'],
