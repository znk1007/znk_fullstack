...
abstract class StateDelegate {
  ...
  /// [StateDelegate]of a different [runtimType]. 
  @protected
  @mustCallSuper
  void initDelegate() {}
  ...
  InheritedWidget dependOnInheritedElement(Element ancestor, {Object aspect}) {
     assert((){
       if (_debugIsInitDelegate) {
         ...
         throw FlutterError('''
          dependOnInheritedWidgetOfExactType<$targetType>() or inheritFromElement() was called
...
/// A [delegateWidget]that accept only [ValueStateDelegate]as [delegate].  
/// 
/// See also:
/// 
/// * [DelegateWidget]
...
abstract class ValueDelegateWidget<T> extends DelegateWidget {
  ...
  @override
  @protected
  ValueStateDelegate get delegate => super.delegate as ValueStateDelegate<T>;
}