...
/// 
/// To create a value, use the default constructor. Creating the instance inside
/// `build` using [ChangeNotifierProvider.value] will lead to memory leaks and 
...
/// which explains in further details why using the `.value` constructor to create
/// values is undesired.
/// 
...
class ChangeNotifierProvider<T extends ChangeNotifier>
  ...
  ///     if (_foo != value) {
  ///       _foo = value;
  ///       // do some extra work, that my call `notifyListeners()`
  ///     }
  ///   }
  /// }
  /// ```
  ...
  /// It will also cause uncesserary overhead because it will dispose the previous
  /// notifier, the subscribes to the new one
  /// 
