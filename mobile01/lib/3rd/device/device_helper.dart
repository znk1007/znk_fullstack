...
class DeviceHelper {
  ...
  static const MethodChannel channel = MethodChannel('device_helper');
  ...
  Future<AndroidDeviceHelper> get androidInfo async => 
    _cachedAndroidDeviceHelper ??= AndroidDeviceHelper._fromMap(await channel.invokeMapMethod<String, dynamic>('getAndroidDeviceInfo'));
