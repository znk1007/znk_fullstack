...
//PreparedMessage caches on the wire(导体) representations of a message payload.
//Use PreparedMessage to efficiently send a message payload to multiple connections.
//PreparedMessage is especially useful when compression is used because the CPU and
//memory expensive compression operation can be executed once for a given set of
//compression options.
...
func (pm *PreparedMessage) frame(key prepareKey) (int, []byte, error) {
	...
	frame.once.Do(func() {
		...
		//TODO: Refactor code in conn.go to allow more direct
