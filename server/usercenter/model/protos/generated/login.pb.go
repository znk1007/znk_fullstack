...
var fileDescriptor_67c21677aa7f4e4f = []byte{
	...
	0x07, 0x71, 0x25, 0xcc, 0x55, 0x52, 0x68, 0x02, 0xc5, 0x4a, 0x0c, 0x4e, 0xdc, 0x51, 0x60, 0x0d,
	0x60, 0x8f, 0x24, 0xb1, 0x81, 0x29, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x1d, 0x7c, 0xf7,
	0xc4, 0xde, 0x00, 0x00, 0x00,
}
...
func (c *loginSrvClient) UserLogin(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginRes, error) {
	out := new(LoginRes)
...
func (*UnimplementedLoginSrvServer) UserLogin(ctx context.Context, req *LoginReq) (*LoginRes, error) {
