...
class Struct extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Struct', package: const $pb.PackageName('google.protobuf'))
    ..m<$core.String, Value>(1, 'fields', 'Struct.FieldsEntry',$pb.PbFieldType.OS, $pb.PbFieldType.OM, Value.create, null, null , const $pb.PackageName('google.protobuf'))
    ..hasRequiredFields = false
  ;

  Struct() : super();
  Struct.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Struct.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Value', package: const $pb.PackageName('google.protobuf'))
    ..oo(0, [1, 2, 3, 4, 5, 6])
...
class ListValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ListValue', package: const $pb.PackageName('google.protobuf'))
    ..pc<Value>(1, 'values', $pb.PbFieldType.PM,Value.create)
    ..hasRequiredFields = false
  ;

  ListValue() : super();
  ListValue.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  ListValue.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
